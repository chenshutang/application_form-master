  ...
  Rolldate.prototype = {
    ...
    baseData: function baseData() {
      return {
        ...
        opts: { //插件默认配置
          ...
          minStep: 1,
          trigger: 'tap',
          lang: { title: '选择日期', cancel: '取消', confirm: '确认', year: '', month: '', day: '', hour: '时', min: '分', sec: '秒' }
        }
      };
    },
    ...
    createUI: function createUI() {
      ...
      var $html = `<div class="rolldate-mask"></div>
                    ...
                    <header>
                      <div class="headerBtnContainer clearfix">
                        <button id='cancel' type="button" class="rolldate-btn rolldate-cancel btn btn-xs cancel">${lang.cancel}</button>
                        <button id='confirm' type="button" class="rolldate-btn rolldate-confirm btn btn-xs btn-primary confirm">${lang.confirm}</button>
                      </div>
                      <div class="headerContent">
                        <div class="left">年</div>
                        <div class="middle">月</div>
                        <div class="right">日</div>
                      </div>
                    </header>
                    <section class="rolldate-content">
                      <div class="rolldate-dim mask-top"></div>
                      <div class="rolldate-dim mask-bottom"></div>
                      <div class="rolldate-wrapper">${ul}</div>
                    </section>
                  </div>`,
